...
zip_layers_view = (
    groupbykey.set_task_instance_id("zip_layers_view")
    .handle_errors()
    .with_tracing()
    .skipif(
        conditions=[
    ...
    .partial(
        iterables=[combine_custom_map_layers, zoom_view_state], **zip_layers_view_params
    )
    .call()
)
...
zip_metrics_etd = (
    groupbykey.set_task_instance_id("zip_metrics_etd")
    .handle_errors()
    .with_tracing()
    .skipif(
        conditions=[
    ...
    .partial(
        iterables=[persist_summary_table, collared_html_png], **zip_metrics_etd_params
    )
    .call()
)
...
get_grouper_names = (
    ...
    .partial(split_data=split_subject_traj_groups, **get_grouper_names_params)
    .call()
)
...
generate_collared_report_params = dict()
...
generate_collared_report = (
    merge_docx_files.set_task_instance_id("generate_collared_report")
    .handle_errors()
    .with_tracing()
    .skipif(
        conditions=[
    ...
    .partial(
        ...
        **generate_collared_report_params,
    )
    .call()
)

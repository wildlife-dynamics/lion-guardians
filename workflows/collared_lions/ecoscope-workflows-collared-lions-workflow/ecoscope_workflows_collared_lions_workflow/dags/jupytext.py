...
zip_layers_view = (
    ...
    .partial(
        sequences=[combine_custom_map_layers, zoom_speed_gdf_extent],
        **zip_layers_view_params,
    )
    .call()
)
...
zip_value = (
    zip_groupbykey.set_task_instance_id("zip_value")
    .handle_errors()
    .with_tracing()
    .skipif(
        conditions=[
    ...
    .partial(sequences=[gdf_image_extent, td_ecomap_html_url], **zip_value_params)
    .call()
)
...
collared_html_png = (
    adjust_map_zoom_and_screenshot.set_task_instance_id("collared_html_png")
    .handle_errors()
    .with_tracing()
    .skipif(
        conditions=[
    ...
    .mapvalues(argnames=["view_state", "input_file"], argvalues=zip_value)
)
...
# %% [markdown]
# ## Combine tracks html path with zoom value

# %%
# parameters

zip_track_value_params = dict()
...
zip_track_value = (
    zip_groupbykey.set_task_instance_id("zip_track_value")
    .handle_errors()
    .with_tracing()
    .skipif(
        conditions=[
    ...
    .partial(sequences=[gdf_image_extent, track_html_url], **zip_track_value_params)
    .call()
)


# %% [markdown]
# ## Convert track html to png

# %%
# parameters

track_html_png_params = dict()
...
track_html_png = (
    adjust_map_zoom_and_screenshot.set_task_instance_id("track_html_png")
    .handle_errors()
    .with_tracing()
    .skipif(
        conditions=[
    ...
    .partial(
        ...
        **track_html_png_params,
    )
    .mapvalues(argnames=["view_state", "input_file"], argvalues=zip_track_value)
)


# %% [markdown]
# ## Create trackmap widget

# %%
# parameters

trackmap_widget_params = dict()
...
trackmap_widget = (
    create_map_widget_single_view.set_task_instance_id("trackmap_widget")
    .handle_errors()
    .with_tracing()
    .skipif(
        conditions=[
    ...
    .partial(title="Subject tracks", **trackmap_widget_params)
    .map(argnames=["view", "data"], argvalues=track_html_url)
)


# %% [markdown]
# ## Merge trackmap widget view
...
sm_grouped_map_widget = (
    ...
    .partial(widgets=trackmap_widget, **sm_grouped_map_widget_params)
    .call()
)

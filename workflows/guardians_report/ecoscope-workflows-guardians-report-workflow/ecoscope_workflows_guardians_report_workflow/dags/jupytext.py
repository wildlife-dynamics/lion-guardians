...
no_of_events_recorded = (
    ...
    .partial(
        widget_id="No of events recorded by guardian", **no_of_events_recorded_params
    )
...
ranger_patrol_recorded = (
    ...
    .partial(widget_id="Ranger patrols summary", **ranger_patrol_recorded_params)
...
patrol_types_recorded = (
    ...
    .partial(widget_id="Patrol types summary", **patrol_types_recorded_params)
...
event_types_recorded = (
    ...
    .partial(widget_id="Event types summary", **event_types_recorded_params)

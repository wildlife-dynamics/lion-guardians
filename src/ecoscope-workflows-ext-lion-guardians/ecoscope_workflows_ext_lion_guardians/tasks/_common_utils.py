...
def html_to_img(
    ...
    config: Annotated[ScreenshotConfig, Field(description="The screenshot configuration")] = ScreenshotConfig(),
) -> str:
    ...
    with sync_playwright() as p:
        ...
        page = browser.new_page(
            viewport={"width": config.width, "height": config.height}, device_scale_factor=config.device_scale_factor
        )
